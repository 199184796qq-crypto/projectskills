...
description: |
  当用户需要为产品文案选择和编排顾客评价/口碑素材时调用此 skill。适用场景：电商详情页、落地页、社交媒体推广中需要用真实用户反馈增强说服力。不适用于：产品功能说明、品牌故事、技术参数描述。关键 trigger 信号：用户提到"好评""口碑""用户反馈""证言""社会证明""买家秀"。此 skill 包含畅销暗示技巧——大企业列销量数据，中小企业讲生动细节。
