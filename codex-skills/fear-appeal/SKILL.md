...
name: fear-appeal
description: |
  当用户需要用"先让读者感到痛，再递上解决方案"的方式激发购买欲时，调用此 skill。核心操作是痛苦场景（具体、清晰）+ 严重后果（难以承受）两步法。特别适用于省事型、预防型和治疗型产品。不适用于享乐型/体验型产品（如零食、旅游、娱乐），也不适用于品牌形象广告。关键触发信号：用户提到"怎么让读者意识到问题的严重性""怎么制造紧迫需求""产品解决一个痛点但读者不够重视"。
source_book: 《爆款文案》 关健明
source_chapter: 第一章 1.2 恐惧诉求
tags: [恐惧诉求, 痛点挖掘, 场景描写, 购买欲激发, 心理动机]
related_skills: [copywriting-four-step-system, cognitive-contrast, usage-scenario]
---
