...
description: |
  当用户需要为产品或品牌引入权威背书以建立信任时调用此 skill。适用场景：新品上市缺乏认知度、高客单价产品需要信任支撑、功效型产品需要专业认可。不适用于：已有强品牌认知的成熟产品、低价快消品（权威背书反而显得过度包装）。关键 trigger 信号：用户提到"认证""获奖""合作机构""专家推荐""权威背书"。核心方法：树立权威的高地位，再描述权威的严格标准，将权威的光环嫁接到产品上。
source_book: 《爆款文案》 关健明
source_chapter: 第二章 2.1
tags: [文案, 权威背书, 信任建立, 品牌背书, 认证营销]
related_skills: [copywriting-four-step-system, customer-testimonial, factual-evidence]
---
